...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 11, 2019 at 07:15 PM
...
INSERT INTO `login` (`user_id`, `name`, `username`, `password`, `email`, `dob`, `gender`, `mobile`, `member`, `img`, `cimg`, `curr_comp`, `curr_loc`, `curr_role`, `skill`, `twitter`, `fb`, `linked`, `github`) VALUES
(9, 'dheraj', 'dheeraj', '$2y$10$JvOv/Yl.3eCdHdMcGtKOIekw1mJ81/dWjeBvfcGsXxHDeTCliUCfm', 'satyaswarup98@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(15, '', 'KhooniKhanjar', '$2y$10$QC5FCnqa147ewxlSZhjStOZrmM7yVLbAVPmN2Pe3Xm3O.WwEbI2GW', 'df', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(16, 'satya', 'satya098', '$2y$10$4Yrkwk8t6tC6K1fdvOTr3ORCvOXjQXQbvtxJ2Q33500e3IL9sGnU6', 'dfgswarup982@gmail.com', '0000-00-00', 'male', 862175632, 'alumini', NULL, NULL, 'Apple', 'Bangalore', 'Devloper', 'c++, PHP, CSS', 'lkhfuibsbi.husfg', 'satyaswarup98@gmail.com', 'satyaswarup98@gmail.com', 'satyaswarup98@gmail.com'),
(17, '', 'Logan', '$2y$10$ofgsR6fKpFVhV473JulnYuBPF/iPcjDgAi7FD8YYyym5yqEhnfw1a', 'ssumit8195@gmail.com', '1996-12-11', 'm', 775509010, 'student', NULL, NULL, '', 'varanasi', 'student', 'c++,', NULL, NULL, NULL, NULL),
(18, '', 'kritisingh', '$2y$10$tN369KCpc.WeA6uIXZ118egOclPXP8Q0a3zd6cP0ua0ESn7LVeDyi', 'erye', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(19, '', 'skhattri', '$2y$10$PXOVGgNArGxx0icXbZ2BqOfHYT6WrReBOzLMKRqyT2Vp4oaHq5M3S', 'wetweg', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(73, 16, '2019-12-11 07:14:24', 'no'),
(74, 16, '2019-12-11 08:49:21', 'no');
...
INSERT INTO `question` (`id`, `topic`, `describe`, `image`, `confirm`, `time`) VALUES
(28, 'fgh', 'fghth', 'iit.jpg', 1, '2019-12-05 12:26:34');
...
--
ALTER TABLE `answers`
  MODIFY `answer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
...
--
ALTER TABLE `login_details`
  MODIFY `login_details_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
...
--
ALTER TABLE `questions`
  MODIFY `q_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;
COMMIT;
